...
{
    /// <summary>
    /// Also add <see cref="RunBlazorBlogBuilder"/>
    /// </summary>
    public static void AddBlazorBlogBuilder(this IServiceCollection services, SiteConfig config)
    {
    ...
    /// 
    /// Also add <see cref="AddBlazorBlogBuilder"/>
    /// </summary>
    public static void RunBlazorBlogBuilder(this WebApplication app, SiteConfig config)
    {
        ...
        lifetime.ApplicationStarted.Register(async () =>
        {
            ...
            var logger = app.Services.GetRequiredService<ILoggerFactory>().CreateLogger("BlazorBlogBuilder");
