...
* Add `<Summary>` and `<Update>` to your posts or any other page
...
https://www.silentorbit.com/static-online/blog/

## Getting started

1. Download the demo at https://github.com/silentorbit/StaticOnlineDemo
...
* NuGet: https://www.nuget.org/packages/SilentOrbit.StaticOnline/
  * Add the NuGet package to your Blazor app
* Git: https://github.com/silentorbit/StaticOnline
  * Reference the StaticOnline project

Modify your Blazor app according to the demo https://github.com/silentorbit/StaticOnlineDemo
* `Program.cs`
* `App.razor`
...
* [SilentOrbit/support/discussions](https://github.com/silentorbit/support/discussions)
